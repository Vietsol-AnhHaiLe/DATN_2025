...
#define AI_NETWORK_IN_1_HEIGHT      (192)
#define AI_NETWORK_IN_1_WIDTH       (192)
#define AI_NETWORK_IN_1_CHANNEL     (3)
#define AI_NETWORK_IN_1_SIZE        (110592)
...
#define AI_NETWORK_OUT_1_HEIGHT      (3845)
#define AI_NETWORK_OUT_1_CHANNEL     (5)
#define AI_NETWORK_OUT_1_SIZE        (19225)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (76900)
#define AI_NETWORK_OUT_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_OUT_2_HEIGHT      (3845)
#define AI_NETWORK_OUT_2_CHANNEL     (4)
#define AI_NETWORK_OUT_2_SIZE        (15380)
#define AI_NETWORK_OUT_2_SIZE_BYTES  (61520)
#define AI_NETWORK_OUT_3_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_OUT_3_HEIGHT      (3845)
#define AI_NETWORK_OUT_3_CHANNEL     (4)
#define AI_NETWORK_OUT_3_SIZE        (15380)
#define AI_NETWORK_OUT_3_SIZE_BYTES  (61520)

/******************************************************************************/
#define AI_NETWORK_N_NODES (195)
